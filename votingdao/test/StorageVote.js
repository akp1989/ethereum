...
const deploymentConfig = {
  ...
  contract('StorageVote', ([deployer, summoner, applicant1, applicant2, processor, ...otherAccounts]) => {
    ...
    const verifySubmitProposal = async (
      ...
      const votingBalance = await treasury.getTokenBalance()
      assert.equal(
        votingBalance,
    ...
    it('verify deployment parameters', async () => {
      ...
      const treasuryAccountAddress = await voting.treasury()
    ...
    describe('Submit Proposal',() =>{
      ...
      it('Fail - Zero candidates', async() =>{
        await voting.submitProposal(proposal1.objectiveProposal,
                                    ...
                                    proposal1.details,
                                    {from:summoner}
                                  ).should.be.rejectedWith('Candidate list empty');
      })
      ...
      it('Fail - Objective proposal with multiple candidates', async() =>{
        await voting.submitProposal(proposal1.objectiveProposal,
                                    ...
                                    proposal1.details,
                                    {from:summoner}
                                  ).should.be.rejectedWith('1 candiate only');
      })
      ...
      it('Fail - Insufficient proposal deposit', async () => {
        ...
        await voting.submitProposal(proposal1.objectiveProposal,
                                    ...
                                    proposal1.details,
                                    {from:summoner}
                                  ).should.be.rejectedWith('Proposer lacks token for deposit');
      })
      ...
      it('Fail - Insufficient authorized proposal deposit', async () => {
        ...
        await voting.submitProposal(proposal1.objectiveProposal,
                                    ...
                                    proposal1.details,
                                    {from:summoner}
                                  ).should.be.rejectedWith('Transfer not authorized by proposer');
      })
      ...
      it('Fail - Insufficient applicant tokens', async () => {
        ...
        await voting.submitProposal( proposal1.objectiveProposal,
                                    ...
                                    proposal1.details,
                                    {from:summoner}
                                  ).should.be.rejectedWith("Candidate lack token deposit")
      })
      ...
      it('Fail - Insufficient authorized applicant tokens', async () => {
        ...
        await voting.submitProposal( proposal1.objectiveProposal,
                                    ...
                                    proposal1.details,
                                    {from:summoner}
                                  ).should.be.rejectedWith("Transfer not authorized by candidate")
      })
      ...
      it('Fail - Proposal by non-delegator', async () => {
        await voting.submitProposal( proposal1.objectiveProposal,
                                    ...
                                    proposal1.details,
                                    { from: applicant1 }
                                  ).should.be.rejectedWith('Non-member')
      })
    ...
    ****************************************************************************/
     describe('Process proposal - Objective', () => {
      ...
      it('Fail - Voting periond not completed', async() =>{
        await voting.processProposal(0,{from:processor}).should.be.rejectedWith("not ready");
      })

      it('Fail - Invalid index for proposal queue', async() =>{
        await voting.processProposal(99,{from:processor}).should.be.rejectedWith("Invalid proposal");
      })
